...
cs_over:function(e){
	_Calendar.evtTgt(_Calendar.EvtObj(e)).style.background='#f3d131';
},
...
document.write('<tr><td onclick="_Calendar.csubm()">&laquo;</td><td colspan="5" id="mns"></td><td align="right" style="cursor:pointer;font-size:15px" onclick="_Calendar.caddm()">&raquo;</td></tr>');
document.write('<tr><td>Пн</td><td>Вт</td><td>Ср</td><td>Чт</td><td>Пт</td><td>Сб</td><td>Вс</td></tr>');
